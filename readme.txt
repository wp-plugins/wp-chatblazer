...
Tags: wordpress chat, chat wordpress, chatroom, chatblazer, chat, live chat, embed chatroom, video chat, instant messaging, host chatroom, multisite, live chat, two-way chat, widget, chat widget, widget chat
Requires at least: 2.8
Tested up to: 3.4.1
Stable tag: 1.6

WP Chatblazer is a plugin to allow you to embed a Chatblazer application to chat on a Wordpress page.  Embed instant messaging and video chat directly on pages and posts with a simple shortcode.  Works on multisite.    
...
WP-ChatBlazer is available for chat in:
...
3. Go to the plugin management page and enable the Chatblazer chat plugin
...
1. WP-ChatBlazer chat Options
2. Embedded Chatblazer on a Wordpress chat page

== Documentation ==

Full chat documentation can be found on the [WP-ChatBlazer Page](http://wp-chatblazer.com) page.

== Frequently Asked Questions ==

= I get the message "Domain is not allowed to host this application" =

In order to use Chatblazer for chat you will need to signup for a free hosted chat for your domain at www.chatblazer.com.

= Does Chatblazer run on an iPad? =

Because Chatblazer software uses Flash to chat, it will NOT run on an ipad, or any other platform that does not natively support Flash. However, there is a non-flash chat version under development.
...
= 1.1   =
* Added description, tags, and link to chatblazer in chat settings page
= 1.6   =
* Added a flash detection script to display an error message instead of the chat if the user does not have the minimum flash version that is required to use chatblazer for chat.
